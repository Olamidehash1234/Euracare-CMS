...
export default function AdminTable({ admins, onView, onEdit, onDelete }: AdminTableProps) {
  return (
            ...
            <tr key={admin.id} className="border-t border-[#01010133]">
              ...
              <td className="w-[250px] py-[19px] pl-4 pr-0 align-middle">
                <div className="flex items-center gap-3">
                  <img src={admin.avatar ? admin.avatar : '/placeholder-image.png'} alt="" className="w-10 h-10 lg:w-[36px] lg:h-[36px] rounded-full" />
