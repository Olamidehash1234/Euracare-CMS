      ...
      <table className="w-full text-left table-auto">
        <thead>
          <tr className="text-[14px] text-[#0C2141]">
            ...
            <th className="w-[100px] pt-[22px] pb-[25px] text-[14px] font-medium leading-[20px] px-4">Thumbnail</th>
            <th className="w-[200px] pt-[22px] pb-[25px] text-[14px] font-medium leading-[20px] px-4">Title</th>
            <th className="w-[150px] pt-[22px] pb-[25px] text-[14px] font-medium leading-[20px] px-4">Service</th>
            <th className="w-[150px] pt-[22px] pb-[25px] text-[14px] font-medium leading-[20px] px-4">Patient Name</th>
          ...
          {testimonials.map((t) => (
            <tr key={t.id} className="border-t border-[#01010133]">
              ...
              <td className="w-[100px] py-[19px] px-4 align-middle">
                {t.thumbnailUrl ? (
                  <img src={t.thumbnailUrl} alt="Thumbnail" className="w-[80px] h-[60px] object-cover rounded" />
                ) : (
                  <div className="w-[80px] h-[60px] bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">No image</div>
                )}
              </td>
              <td className="w-[200px] py-[19px] px-4 align-middle">
                <div className="font-normal text-[14px] truncate">{t.title}</div>
              </td>
              <td className="w-[150px] py-[19px] px-4 align-middle text-[14px] text-[#010101]">{t.service}</td>
              <td className="w-[150px] py-[19px] px-4 align-middle text-[14px] text-[#010101]">{t.patientName}</td>
