...
const sample: Doc[] = [
  { id: 1, name: 'Dr. Hammed Ninalowo', avatar: '/image/doctor/test1.png' },
  { id: 2, name: 'Dr. Tosin Majekodunmi', avatar: '/image/doctor/test1.png' },
  { id: 3, name: 'Dr. Owen Woghiren', avatar: '/image/doctor/test1.png' },
  { id: 4, name: 'Dr. Abuchi Okaro', avatar: '/image/doctor/test1.png' },
  { id: 5, name: 'Dr. Owen Woghiren', avatar: '/image/doctor/test1.png' },
];
