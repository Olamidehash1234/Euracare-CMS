...
const DepartmentPage = () => {
  ...
  const handleManageMembers = (roleId: string) => {
    // hook up modal or navigation to members management
    console.log('Manage members for', roleId);
  };
        ...
        <div className="p-[16px] lg:p-[40px]">
          <div className="bg-white rounded-[14px] p-6 lg:px-[20px] lg:py-[23px] shadow-sm border border-gray-200">
            ...
            {mockRoles.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:mb-[200px]">
                {mockRoles.map((role) => {
