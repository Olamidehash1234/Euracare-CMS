...
const overviewService = {
  getOverviewData: async () => {
    try {
      ...
      //   console.log('📊 [overviewService] Audit activities:', overview.audit);
      //   console.log('📊 [overviewService] Audit count:', overview.audit?.length);
      //   if (overview.audit && overview.audit.length > 0) {
      //     console.log('📊 [overviewService] First audit entry:', overview.audit[0]);
      //   }
      // }
